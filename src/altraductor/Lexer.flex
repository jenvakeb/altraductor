...
ADVE_TIEMPO="TODAY"|"YESTERDAY"|"TOMORROW"|"LATE"|"EARLY"|"NOW"
ADVE_FRECUENCIA="NEVER"|"ALWAYS"|"OFTEN"|"SOMETIMES"|"FREQUENTLY"|
"SELDOM"|"RARELY"|"DAILY"|"WEEKLY"|"MONTHLY"|"YEARLY"
ADVE_LUGAR="HERE"|"THERE"|"EVERYWHERE"|"NOWHERE"|"INSIDE"|
"OUTSIDE"|"UPSTAIRS"|"DOWNSTAIRS"
ADVE_MANERA="WELL"|"BADLY"|"QUICKLY"|"SLOWLY"|"SOFTLY"|"LOUDLY"|"GREEDILY"|"GENEROUSLY"|
"HAPPILY"|"SADLY"|"INTERESTINGLY"|"KNOWINGLY"
...
"/" {return division;}
"+" {return suma;}
{ADVE_TIEMPO} {lexeme=yytext(); return ADV_TIME;}
{ADVE_FRECUENCIA} {lexeme=yytext(); return ADV_FRECUENCIA;}
{ADVE_LUGAR} {lexeme=yytext(); return ADV_LUG;}
{ADVE_MANERA} {lexeme=yytext(); return ADV_MANERA;}
...
{PROFESIONES} {lexeme=yytext(); return PROF;}
{VEGETALES} {lexeme=yytext(); return VEGET;}
{PAISES} {lexeme=yytext(); return PAIS;}
{ANIMALES} {lexeme=yytext(); return ANIMALS;}
